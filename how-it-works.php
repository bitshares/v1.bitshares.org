...
<h2>How BitShares Works</h2>
<h2 class="subheader">A Currency, A Bank, An Exchange, A Community
</h2>
</div>
<hr>
</div>
...
<div class="large-12 columns">
     ...
     <p>The endgame for the BTS token (lowercase-b "bitshares") is to trade as equity in profitable decentralized network that can outcompete existing centralized solutions for basic financial services with nothing but free software and free speech.
     </p>
...
<div class="large-12 columns">
  ...
  <h3>BitAssets for Spenders, Savers, and Traders</h3>
     <h4 class="subheader">BitAssets, the currency of BitShares, are digital asset tokens that have eliminated the burden of price volatility. </h4>
     
      <p>This means that bitUSD, bitEuro, bitCNY and bitGold track their respective assets like dollar, euro, yuan and gold on crypto-currency exchanges worldwide, and can all be freely traded against each other for a small fixed fee.</p>
     
      <p>BitAssets are helping businesses and shoppers avoid the hassle of having to constantly transfer their holdings back and forth between crypto and cash to evade costly price fluctuations. For traders, BitAssets are providing the opportunity to trade in the value of their favorite currency or commodity without leaving the privacy and convenience of the blockchain. And for all users, bitAssets pay a daily interest rate that rivals or even surpasses many savings banks.</p>
     
     <p>BitAssets are not issued by any central authority. Instead, they are created as a side-effect of trades which happen inside the trust-free exchange that is hardwired into the BitShares blockchain. The end result of these swaps is the creation of 300% collateralized bitAsset tokens that each pay a proportional dividend of the combined interest paid by the open short positions. Because of this, BitAsset holders have the unique privilege of earning interest on commodities such as gold, silver, and oil, as well as commonly interest bearing instruments like dollars and euro. A detailed explanation of how this works can be found in the BitShares market-pegged asset whitepaper.</p>
...
<div class="large-12 columns">
  ...
  <h3>DPOS</h3>
     <h4 class="subheader">Delegated Proof of Stake</h4>
      ...
      <p>Delegates can also campaign to have a higher pay rate than what is necessary to run a block-producing node. Shareholders typically use this functionality to fund the development of the BitShares ecosystem. Learn more about delegates.</p>
