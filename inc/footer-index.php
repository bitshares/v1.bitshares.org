   ...
   <div class="large-12 columns">
    ...
    <script src="../assets/js/bitsharesticker.js"></script> 
    <script>
    jQuery('.bitsharesticker').bitsharesticker({
           title : '',
           source: 'http://www.bitsharesdemo.com/presta/bitshares/checkout/callbacks/callback_getfeedprices.php',
           currencyPrimary : 'GOLD, SILVER, BTC',
           currencySecondary : 'USD, EUR, GBP'
       });
