...
<h2>Thank you…</h2>
<h2 class="subheader">…for downloading BitShares Software</h2>
</div>
<hr>
</div>
...
<div class="row ">
<img class="show-for-medium-up" style="width: 96%; height: auto; opacity: 0.5;margin-top: 24px;" src="../assets/images/bg-trianlge-mesh-sm.svg" />
